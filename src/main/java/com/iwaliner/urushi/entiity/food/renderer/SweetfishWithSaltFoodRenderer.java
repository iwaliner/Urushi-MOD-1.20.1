...
import com.iwaliner.urushi.entiity.food.SweetfishFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class SweetfishWithSaltFoodRenderer<T extends SweetfishWithSaltFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SweetfishWithSaltFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new DangoFoodModel<>(context.bakeLayer(ClientSetUp.SWEETFISH));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/sweetfish_with_salt.png");
    }
    ...
    public ResourceLocation getTextureLocation(SweetfishWithSaltFoodEntity p_110775_1_) {
