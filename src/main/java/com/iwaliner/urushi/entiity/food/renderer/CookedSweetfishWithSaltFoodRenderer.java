...
import com.iwaliner.urushi.entiity.food.CookedSweetfishWithSaltFoodEntity;
import com.iwaliner.urushi.entiity.food.FoodEntity;
import com.iwaliner.urushi.entiity.food.SweetfishWithSaltFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class CookedSweetfishWithSaltFoodRenderer<T extends CookedSweetfishWithSaltFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public CookedSweetfishWithSaltFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new DangoFoodModel<>(context.bakeLayer(ClientSetUp.SWEETFISH));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/sweetfish_cooked_with_salt.png");
    }
    ...
    public ResourceLocation getTextureLocation(CookedSweetfishWithSaltFoodEntity p_110775_1_) {
