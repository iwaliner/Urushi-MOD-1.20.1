...
import com.iwaliner.urushi.entiity.food.GomokuGohanFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class GomokuGohanFoodRenderer<T extends GomokuGohanFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public GomokuGohanFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/gomoku.png");
    }
    ...
    public ResourceLocation getTextureLocation(GomokuGohanFoodEntity p_110775_1_) {
