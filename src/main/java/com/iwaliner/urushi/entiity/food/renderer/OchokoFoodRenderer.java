...
import com.iwaliner.urushi.entiity.food.OchokoFoodEntity;
import com.iwaliner.urushi.entiity.food.SakeFoodEntity;
import com.iwaliner.urushi.entiity.food.model.OchokoFoodModel;
...
@OnlyIn(Dist.CLIENT)
public class OchokoFoodRenderer<T extends OchokoFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public OchokoFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new OchokoFoodModel<>(context.bakeLayer(ClientSetUp.OCHOKO));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/ochoko.png");
    }
    ...
    public ResourceLocation getTextureLocation(OchokoFoodEntity p_110775_1_) {
