...
import com.iwaliner.urushi.entiity.food.ShrimpSushiFoodEntity;
import com.iwaliner.urushi.entiity.food.model.ShrimpSushiFoodModel;
...
@OnlyIn(Dist.CLIENT)
public class ShrimpSushiFoodRenderer<T extends ShrimpSushiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public ShrimpSushiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new ShrimpSushiFoodModel<>(context.bakeLayer(ClientSetUp.SHRIMP_SUSHI));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/shrimp_sushi.png");
    }
    ...
    public ResourceLocation getTextureLocation(ShrimpSushiFoodEntity p_110775_1_) {
