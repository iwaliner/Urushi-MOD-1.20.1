...
@OnlyIn(Dist.CLIENT)
public class SweetfishFoodRenderer<T extends SweetfishFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SweetfishFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new DangoFoodModel<>(context.bakeLayer(ClientSetUp.SWEETFISH));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/sweetfish.png");
    }
    ...
    public ResourceLocation getTextureLocation(SweetfishFoodEntity p_110775_1_) {
