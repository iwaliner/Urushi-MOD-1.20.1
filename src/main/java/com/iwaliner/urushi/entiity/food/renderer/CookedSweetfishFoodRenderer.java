...
import com.iwaliner.urushi.entiity.food.CookedSweetfishFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class CookedSweetfishFoodRenderer<T extends CookedSweetfishFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public CookedSweetfishFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new DangoFoodModel<>(context.bakeLayer(ClientSetUp.SWEETFISH));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/sweetfish_cooked.png");
    }
    ...
    public ResourceLocation getTextureLocation(CookedSweetfishFoodEntity p_110775_1_) {
