...
@OnlyIn(Dist.CLIENT)
public class SakeFoodRenderer<T extends SakeFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SakeFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SakeFoodModel<>(context.bakeLayer(ClientSetUp.SAKE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/sake.png");
    }
    ...
    public ResourceLocation getTextureLocation(SakeFoodEntity p_110775_1_) {
