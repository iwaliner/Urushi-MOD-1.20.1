...
import com.iwaliner.urushi.entiity.food.MandarinFoodEntity;
import com.iwaliner.urushi.entiity.food.model.GreenTeaFoodModel;
import com.iwaliner.urushi.entiity.food.model.MandarinFoodModel;
...
@OnlyIn(Dist.CLIENT)
public class MandarinFoodRenderer<T extends MandarinFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public MandarinFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new MandarinFoodModel<>(context.bakeLayer(ClientSetUp.MANDARIN));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/mandarin.png");
    }
    ...
    public ResourceLocation getTextureLocation(MandarinFoodEntity p_110775_1_) {
