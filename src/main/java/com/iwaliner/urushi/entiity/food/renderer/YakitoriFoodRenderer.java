...
import com.iwaliner.urushi.entiity.food.YakitoriFoodEntity;
import com.iwaliner.urushi.entiity.food.model.DangoFoodModel;
import com.iwaliner.urushi.entiity.food.model.YakitoriFoodModel;
...
@OnlyIn(Dist.CLIENT)
public class YakitoriFoodRenderer<T extends YakitoriFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public YakitoriFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new YakitoriFoodModel<>(context.bakeLayer(ClientSetUp.YAKITORI));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/yakitori.png");
    }
    ...
    public ResourceLocation getTextureLocation(YakitoriFoodEntity p_110775_1_) {
