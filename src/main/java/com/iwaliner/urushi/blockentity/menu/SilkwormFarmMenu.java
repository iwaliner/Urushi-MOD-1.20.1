...
public class SilkwormFarmMenu extends RecipeBookMenu<Container> {
    ...
    private final RecipeType<? extends SilkFarmRecipe> recipeType;
    private final RecipeBookType recipeBookType;

    public SilkwormFarmMenu(int p_38963_, Inventory p_38964_) {
        this(MenuRegister.SilkwormFarmMenu.get(), RecipeTypeRegister.SilkwormFarmRecipe, p_38963_, p_38964_, new SimpleContainer(3), new SimpleContainerData(4));
    }

    public SilkwormFarmMenu(MenuType<?> p_38966_, RecipeType<? extends SilkFarmRecipe> p_38967_, int p_38969_, Inventory p_38970_, Container p_38971_, ContainerData p_38972_) {
