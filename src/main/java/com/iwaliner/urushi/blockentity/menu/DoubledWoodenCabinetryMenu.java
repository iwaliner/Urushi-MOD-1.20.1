...
public class DoubledWoodenCabinetryMenu extends AbstractContainerMenu {
    ...
    /*public boolean clickMenuButton(Player player, int p) {
        NonNullList<ItemStack> list1=NonNullList.withSize(300,ItemStack.EMPTY);
        NonNullList<ItemStack> list2=NonNullList.withSize(300,ItemStack.EMPTY);
        NonNullList<ItemStack> list3=NonNullList.withSize(300,ItemStack.EMPTY);
        NonNullList<ItemStack> list4=NonNullList.withSize(300,ItemStack.EMPTY);
...
//ここより上に問題がある
    ...
    public boolean clickMenuButton(Player player, int p) {
        ...
        NonNullList<ItemStack> list2=NonNullList.withSize(108,ItemStack.EMPTY);
        NonNullList<ItemStack> list3=NonNullList.withSize(108,ItemStack.EMPTY);
        NonNullList<ItemStack> list4=NonNullList.withSize(108,ItemStack.EMPTY);
