...
public class FoodUrushi {
    ...
    public static final FoodProperties MisoSoup = (new FoodProperties.Builder()).nutrition(5).saturationMod(0.4F).build();
    public static final FoodProperties Hiyayakko = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.4F).build();
